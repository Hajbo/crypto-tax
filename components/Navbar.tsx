...
const Navbar = () => {
 return (
    <div style={NavbarStyle}>
        <div style={NavbarLeftContainerStyle}><a style={BoldNavbarLinkStyle} href="#">KRIPTOBEVALLAS.HU</a></div>
        <div style={NavbarRightContainerStyle}>
        {links.map((link) => (
            <a style={NavbarLinkStyle} key={`nav-${link.href}`} href={link.href}>{link.text}</a>
        ))}
        </div>
    </div>
 )   
